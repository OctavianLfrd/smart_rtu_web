@section('header')
    <header class="header">
        <nav class="navbar navbar-expand-sm navbar-dark bg-info text-light fixed-top font-weight-light border-bottom border-light">
            <span class="navbar-brand"><h1 class="font-weight-light text-light">Smart RTU <small><span class="badge badge-lg bg-white text-info">ADMIN</span></small></h1></span>
            ...
            <div class="collapse navbar-collapse" id="navbar-links">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item col"><a href="/ads" class="nav-link text-light"><i class="material-icons d-inline">pageview</i>View</a></li>
